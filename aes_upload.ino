 ...
 * Author: Ricoen
 * Date: 30 July 2019
 * Original author of implementation: Niyaz PK
...
void Cipher()
{
	...
	// Nr-1 merupakan putaran yang telah dieksekusi pada fungsi di bawah ini.
...
void loop() {
  ...
  //Konversi string sensor menjadi hexadesimal
